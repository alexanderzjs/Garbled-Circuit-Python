...
def garbler_init() -> Union[bytes, bytes, bytes, bytes]:
    ...
    return delta, public_one_label, public_one_label_delta
...
def garble_and_gate(input_a: bytes, input_b: bytes, delta: bytes) -> Union[bytes, bytes, bytes]:
    a_0 = input_a
...
def garble_or_gate(input_a: bytes, input_b: bytes, delta: bytes) -> Union[bytes, bytes, bytes]:
    and_output, gtt_0, gtt_1 = garble_and_gate(input_a, input_b, delta)
...
def compute_garbled_circuit(circuit_file: str, ginput: list, gginput_0: list, gginput_1: list, geinput_0: list, public_one_label_delta: bytes, delta: bytes) -> Union[list, list]:
